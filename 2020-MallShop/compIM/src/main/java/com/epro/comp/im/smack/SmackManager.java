...
import com.mike.baselib.utils.ReflectionUtils;
...
public class SmackManager {
   ...
   //public static final String SERVER_IP = "192.168.40.230";
    //public static final String SERVER_IP = "shop.epro.com.cn";
   // public static final String SERVER_IP = "myhpweb.com";
    /**
     * Xmpp 服务器端口
     */
   ...
   // public static final String SERVER_NAME = "192.168.40.230";
    //public static final String SERVER_NAME = "shop.epro.com.cn";
   // public static final String SERVER_NAME = "myhpweb.com";
    /**
     *
     */
...
*/
    ...
    private XMPPTCPConnection createConnection() {
        ...
        logTools.d("isIp:"+InetAddressUtil.isIpAddress(SERVER_IP)) ;
        try {
    ...
    private synchronized boolean connect() {
        if(mConnection!=null){
            logTools.d("port:"+ReflectionUtils.getFieldValue(mConnection.getConfiguration(),"port").toString()) ;
          //  logTools.d("host:"+ReflectionUtils.getFieldValue(mConnection.getConfiguration(),"host").toString()) ;
        }
    ...
    public synchronized boolean login(String username, String password) {
        try {
           ...
           // mConnection.login("merchant180", "merchant180");
            return true;
        } catch (Exception e) {
            logTools.e(e);
            return false;
