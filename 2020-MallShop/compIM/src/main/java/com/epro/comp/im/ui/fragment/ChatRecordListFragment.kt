...
class ChatRecordListFragment : BaseTitleBarListFragment<ChatRecord, ChatRecordListContract.View
    ...
    private fun showClearAllMessage() {
        CommonDialog.Builder(activity!!)
                .setContent(getString(R.string.confirm_to_clear))
    ...
    private fun showDeleteMessage(chatRecord: ChatRecord, position: Int) {
        CommonDialog.Builder(activity!!)
                .setContent(getString(R.string.confirm_to_delete))
                .setOnConfirmListener(object : CommonDialog.OnConfirmListener {
                    override fun onClick(dialog: Dialog) {
                        dialog.dismiss()
    ...
    override fun initView() {
        ...
        super.initView()
        getTitleView().text = getString(R.string.msg_list)
        getLeftView().visibility = View.GONE
        getRightView().text = getString(R.string.empty)
...
//                    getListData()
    ...
    private fun showEmptyView() {
        ...
        val view = EmptyView.Builder(activity!!)
                .setShowText1(getString(R.string.no_news))
                .setShowText2(getString(R.string.login_to_view_message))
                .setImageResoue(R.mipmap.bg_message_empty)
