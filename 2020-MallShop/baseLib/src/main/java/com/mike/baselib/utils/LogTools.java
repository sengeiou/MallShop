...
public class LogTools {
    ...
    private String tag;
    public static int logLevel =AppConfig.Companion.isPublish()?8:0;
    public static String TAG = "_mall_";
    ...
    public static void debug(String tag, Object msg) {
        getInstance().t(TAG).d(tag+"_"+msg);
    }

    public static void debug(Object msg) {
        getInstance().t(TAG).d(msg);
    }

    public static void debug2Json(String tag, Object msg) {
        getInstance().t(TAG). d(tag+"_"+new Gson().toJson(msg));
    }

    public static void debug2Json( Object msg) {
        getInstance().t(TAG).toJson(msg);
    }
