...
public class MutiAppUIListener {
    ...
    public MutiAppUIListener(Activity activity) {
        ...
        rootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                LogTools.debug(rootViewVisibleHeight);
                LogTools.debug(visibleHeight);
                ...
                if (rootViewVisibleHeight - visibleHeight > 200) {
                    if (onMutiAppUIChangeListener != null) {
                        onMutiAppUIChangeListener.mutiAppUIShow(rootViewVisibleHeight - visibleHeight);
                    }
                    rootViewVisibleHeight = visibleHeight;
                    return;
                }
                ...
                if (visibleHeight - rootViewVisibleHeight > 200) {
                    if (onMutiAppUIChangeListener != null) {
                        onMutiAppUIChangeListener.mutiAppUIHide(visibleHeight - rootViewVisibleHeight);
                    }
                    rootViewVisibleHeight = visibleHeight;
                    return;
                }
    ...
    public interface OnMutiAppUIChangeListener {
        void mutiAppUIShow(int height);

        void mutiAppUIHide(int height);
    }

    public static void setListener(Activity activity, OnMutiAppUIChangeListener onMutiAppUIChangeListener) {
        MutiAppUIListener MutiAppUIListener = new MutiAppUIListener(activity);
        MutiAppUIListener.setOnMutiAppUIChangeListener(onMutiAppUIChangeListener);
    }
}