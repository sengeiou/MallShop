...
//data class LoginBean(override val code: Int, override val message: String, override val result: String,  var realResult:Result?) : BaseBean<String> {
...
//    | type     | string | Y    | EP:箱密码登录, MP:手机密码登录, MV:手机验证码登录 ，FB:facebook登录，TW:推特登录 |
    data class Send(val account: String, val password: String,val type:String)
