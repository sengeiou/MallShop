...
import com.mike.baselib.listener.*
...
class MainActivity : BaseSimpleActivity() {
    ...
    // 未被选中的图标
    private val mIconUnSelectIds = intArrayOf(R.mipmap.nav_home_default, R.mipmap.nav_order_default, R.mipmap.nav_message_default,R.mipmap.nav_cart_default, R.mipmap.nav_mine_default)
    // 被选中的图标
    private val mIconSelectIds = intArrayOf(R.mipmap.nav_home_selected, R.mipmap.nav_order_selected,R.mipmap.nav_message_selected ,R.mipmap.nav_cart_selected, R.mipmap.nav_mine_selected)
