...
class NearlyShopListPresenter : ListPresenter<NearlyShop, NearlyShopListContract.View>(), NearlyShopListContract.Presenter {
    ...
    override fun getNearlyShopList(latitude: String, longitude:String,query:String?, city:String?, type: String) {
        checkViewAttached()
        mRootView?.showLoading(type)
        val disposable = model.getNearlyShopList(latitude,longitude,query,city)
                .subscribe({ bean ->
