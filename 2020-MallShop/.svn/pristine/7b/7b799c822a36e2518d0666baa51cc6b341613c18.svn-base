 ...
 */
class PaypalSampleActivity : Activity() {
...
//         */
//
//        val intent = Intent(this@PaypalSampleActivity, PaymentActivity::class.java)
//
...
//                PayPalItem("sample item #3 with a longer specificationsValue", 6, BigDecimal("37.99"), "USD", "sku-33333")
//        )
...
//        val intent = Intent(this@PaypalSampleActivity, PayPalFuturePaymentActivity::class.java)
//
//        // send the same configuration for restart resiliency
//        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config)
//
...
//        val intent = Intent(this@PaypalSampleActivity, PayPalProfileSharingActivity::class.java)
//
//        // send the same configuration for restart resiliency
//        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config)
//
...
//        resultView.text = "Address : " + result
//        Toast.makeText(
//                applicationContext,
...
//       // private val CONFIG_CLIENT_ID = "AUQroQ7_cL1ok3NOfeVoxIHQR0JgAnBIbF7oPwhybTh9APjmjLILT9zXQTJi7-ZuGdWO8LgQogiHgXIV"
...
////                .merchantPrivacyPolicyUri(Uri.parse("https://www.epro.com.cn/"))
////                .merchantUserAgreementUri(Uri.parse("https://www.epro.com.cn/"))
